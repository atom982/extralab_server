                  ...
                  AnaAssays.find({ aparat: mongoose.Types.ObjectId(serijski)}).populate('aparat test').lean().exec(function (err, anaassays) {
                    ...
                    testovi.forEach(element => {
                      ...
                      if (counter < testovi.length) {
                        ...
                        if (element === '256' ||element === '385' || element === '386' || element === '270' || element === '133' || element === '432' ||element === '110' || element === '621' || element === '241' || element === '221' || element === '651' || element === '371' || element === '381' || element === '601' || element === '580' || element === '281' || element === '201' || element === '523' || element === '771' || element === '161' || element === '620' || element === '131' || element === '187' || element === '851' || element === '591' || element === '191' || element === '585' || element === '628' || element === '30' || element === '107' || element === '561' || element === '121' || element === '321' || element === '896' || element === '81' || element === '901' || element === '639' || element === '641' || element === '713' || element === '333' || element === '3' || element === '858' || element === '859') { dilution = 'UNDILUTED' }
